...
@section('title')
    Статусы ордеров - управление на MyCOIN CRYPTO FOUND Plarform
@endsection
@section('content')
        <main role="main" class="main-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Статусы ордеров</h2>
                        <div class="row my-4">
                            <!-- Small table -->
                            <div class="col-md-12">
                                        ...
                                        <div class="modal fade" id="AddNewCat" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{ route('adp.new-order_status')}}">
                                                        @csrf
                                            ...
                                            @foreach($orders as $key=>$data)
                                                ...
                                                <div class="modal fade" id="EditModal{{ $data->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                  action="{{ route('adp.order_status.update', ['id' => $data->id]) }}">
                                                                @csrf
                                                ...
                                                <div class="modal fade" id="DeleteModal{{ $data->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                  action="{{ route('adp.order_status.delete', ['id' => $data->id]) }}">
                                                                @csrf
                                                                <input type="hidden" name="id" value="{{$data->id}}">
                                                                <div class="modal-header">
