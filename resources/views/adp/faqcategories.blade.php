...
@section('title')
    Категории FAQ - управление на MyCOIN CRYPTO FOUND Plarform
@endsection
@section('content')
        <main role="main" class="main-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Категории FAQ</h2>
                        <div class="row my-4">
                            <!-- Small table -->
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="modal fade" id="AddNewCat" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{ route('adp.new-FAQCategories')}}">
                                                        @csrf
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <small id="inProject"
                                                                               class="form-text text-muted">Входит в
                                                                            группу (необязательно)</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <table class="table datatables smaller" id="dataTable-1">
                                            ...
                                            @foreach($FAQCategories as $key=>$data)
                                                <tr>
                                                    <td>{{$data->id}}</td>
                                                    <td>{{$data->name}}</td>
                                                    <th>
                                                        @if($data->parentFaqCategory != NULL)
                                                            {{$data->parentFaqCategory->name}}</span>
                                                        @endif
                                                    </th>
                                                    <td>
                                                        @if($data->desc != NULL)
                                                ...
                                                <div class="modal fade" id="EditModal{{ $data->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                  action="{{ route('adp.FAQCategories.update', ['id' => $data->id]) }}">
                                                                @csrf
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="custom-select"
                                                                                    ...
                                                                                    <option value="0">...</option>
                                                                                    @foreach(\App\Models\FaqCategory::all() as $Faq_Category)
                                                                                        @if (isset($data->parentFaqCategory->id) && $Faq_Category->id == $data->parentFaqCategory->id)
                                                                                            )
                                                                                            <option
                                                                                ...
                                                                                <small id="inProject"
                                                                                       class="form-text text-muted">Входит
                                                                                    в группу (необязательно)</small>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="modal fade" id="DeleteModal{{ $data->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                  action="{{ route('adp.FAQCategories.delete', ['id' => $data->id]) }}">
                                                                @csrf
                                                                <input type="hidden" name="id" value="{{$data->id}}">
                                                                <div class="modal-header">
