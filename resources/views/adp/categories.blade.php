...
@section('title')
    Категории - управление на MyCOIN CRYPTO FOUND Plarform
@endsection
@section('content')
        <main role="main" class="main-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Категории</h2>
                        <div class="row my-4">
                            <!-- Small table -->
                            <div class="col-md-12">
                                        ...
                                        <div class="modal fade" id="AddNewCat" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{ route('adp.new-categories')}}">
                                                        @csrf
                                            ...
                                            @foreach($ProjectCat as $key=>$data)
                                                ...
                                                <div class="modal fade" id="DeleteModal{{ $data->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                  action="{{ route('adp.categories.delete', ['id' => $data->id]) }}">
                                                                @csrf
                                                                <input type="hidden" name="id" value="{{$data->id}}">
                                                                <div class="modal-header">
