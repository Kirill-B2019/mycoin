...
@section('title')
Буквенное значение индекса - управление на MyCOIN CRYPTO FOUND Plarform
@endsection
@section('content')
        <main role="main" class="main-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="mb-2 page-title">Буквенное значение инвестиционного индекса </h2>
                        <div class="row my-4">
                            <!-- Small table -->
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <table class="table datatables smaller" id="dataTable-1">
                                            ...
                                            @foreach($LetterIndex as $key=>$data)
                                                <tr>
                                                    <td>{{$data->id}}</td>
                                                    <td><strong>{{$data->index_name}}</strong></td>
                                                    <td>{{$data->range_start}}</td>
                                                    <td>{{$data->range_stop}}</td>
                                                    <td>{{$data->desc}}</td>
                                                    <td>
                                                        @if($data->used == 1)
                                                ...
                                                <div class="modal fade" id="EditModal{{ $data->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                  action="{{ route('adp.letterIndex.update', ['id' => $data->id]) }}">
                                                                @csrf
