(function($) {
   ...
   // Small navigation functionality
    ...
    function preloader() {
        if($('.preloader').length) {
            $('.preloader').delay(100).fadeOut(500, function() {
                ...
                if ($(".home-style-five .MainPage-banar .banar-title").length) {
                    var heroTitle = $(".home-style-five .MainPage-banar .banar-title");
    ...
    $(window).on("scroll", function() {
        var header = $("#header");
        var mainNavigation = $("#MainPage-navigation");
...
if ($(".urgent-slider").length) {
    ...
    -------------------------------------------*/
    if ($(".shop-SinglePage-slider-wrapper").length) {
        $('.slider-for').slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            arrows: false,
    ...
    if ($("#event-clock").length) {
        $('#event-clock').countdown('2023/09/31', function(event) {
            ...
            + '<div class="box"><div>%D</div> <span>Дней</span> </div>'
            + '<div class="box"><div>%H</div> <span>Часов</span> </div>'
            + '<div class="box"><div>%M</div> <span>Мин</span> </div>'
            + '<div class="box"><div>%S</div> <span>Сек</span> </div>'));
        });
    }
